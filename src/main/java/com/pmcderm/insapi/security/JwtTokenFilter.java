...
public class JwtTokenFilter extends GenericFilterBean {
    ...
    private InsAppUserDetailsService insAppUserDetailsService;

    public JwtTokenFilter(InsAppUserDetailsService userDetailsService) {
        this.insAppUserDetailsService = userDetailsService;
    }
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain filterChain)
        ...
        getBearerToken(headerValue).ifPresent(token-> {
            ...
            insAppUserDetailsService.loadUserByJwtToken(token).ifPresent(userDetails -> {
